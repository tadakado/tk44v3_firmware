...
/*
#define MATRIX_ROW_PINS {7,9,10,11,7,9,10,11}
#define MATRIX_COL_PINS {20,19,18,17,16,15,20,19,18,17,16,15}
#define MATRIX_LAYOUT {\
  1,  2,  3,  4,  5,  6,   30, 29, 28, 27, 26, 25, \
  7,  8,  9, 10, 11, 12,   36, 35, 34, 33, 32, 31, \
 13, 14, 15, 16, 17, 18,   42, 41, 40, 39, 38, 37, \
         21, 22, 23, 24,   48, 47, 46, 45,         255}
*/
